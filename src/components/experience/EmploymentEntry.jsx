        ...
        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50 text-white/80">
            ...
            <div className="z-10 sm:col-span-6">
                <h3 className="font-medium leading-snug">
                    <div>
                        <a
                            ...
                            aria-label={`${jobTitle} at ${company} (opens in a new tab)`}
                            >
                ...
                <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                    {technologiesUsed ? (
                        technologiesUsed.map((technology) => <li className="mr-1.5 mt-2" key={technology}><Tag name={technology} /></li>)
                    ) :
                    (<></>)}
                </ul>
            </div>
